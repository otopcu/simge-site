...
Latest release: **SimGe 0.5.0** (July 5, 2026). This release also includes the 0.5.0.1 update. See [What's New](WhatsNew.md) for a short summary, [Release Notes](ReleaseNotes.md) for the full changelog, or visit the [official site](https://sites.google.com/view/okantopcu/simge){ target="_blank" rel="noopener" }.
