...
Latest release: **SimGe 0.5.1** (July 20, 2026). See [What's New](WhatsNew.md) for a short summary, [Release Notes](ReleaseNotes.md) for the full changelog, or visit the [official site](https://sites.google.com/view/okantopcu/simge){ target="_blank" rel="noopener" }.
